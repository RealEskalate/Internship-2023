...
{
    public class GetAllSeatsQueryHandler : IRequestHandler<GetAllSeatsQuery,BaseCommandResponse<List<SeatDto>>>
    {
    ...
    public async Task<BaseCommandResponse<List<SeatDto>>> Handle(GetAllSeatsQuery request, CancellationToken cancellationToken)
    {
