...
class WeatherRemoteDataSourceImpl implements WeatherRemoteDataSource {
  final baseUrl =
      'https://api.worldweatheronline.com/premium/v1/weather.ashx/?key=7d197f528a0548e085e123715232205&q=New%20Mexico&format=JSON';
  ...
  Future<WeatherModel> getCityWeather(String cityName) async {
    try {
      var response =
          await client.get(Uri.parse('$baseUrl$cityName&appid=$apiKey'));
