...
const DoctorCard: React.FC<DoctorCardProp> = ({ doctor: { _id, fullName, speciality, photo, mainInstitution }, onClick }: DoctorCardProp) => {
    return (
        <div onClick={() => onClick(_id)} className="flex flex-col items-center justify-center p-4 bg-white rounded-3xl shadow-lg">
            ...
            <div className="mt-4 text-center">
                ...
                <p className="text-gray-500 mb-1">
                    <span className="bg-indigo-500 text-white px-2 py-1 rounded-3xl">{speciality[0].name}</span>
                </p>
