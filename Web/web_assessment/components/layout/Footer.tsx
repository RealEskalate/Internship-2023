...
<footer className="text-white bg-indigo-500 mt-8">
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Hakim<span className = "text-red-700">Hub</span></span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white">
              <div>
                  <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white">Get Connected</h2>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white">Actions</h2>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
