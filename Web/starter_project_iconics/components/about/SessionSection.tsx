...
const SessionSection = () => {
    ...
    <div className= "col p-2.5 lg">
        ...
        <p className="font-sans text-2xl font-light">Offering students an ecosystem to actualize their ideas means that up-and-coming developers use their skills to benefit Africa, rather than taking their talent elsewhere.</p>
    </div>
</div>
    )
}
