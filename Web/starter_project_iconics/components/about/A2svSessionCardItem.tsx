...
function CardItem({logo, title, description}:props) {
    ...
    <div className="card_writter flex items-center mb-6 mt-4 p-1">
          <img
            className="card_logo w-10 h-10 object-cover rounded-full mr-2 width{100} height{100}"
            src={logo}
            alt='' />
           </div>
          <div className="card_title flex flex-col items-start">
            <span className="card_title m-0   text-gray-600 p-2">
              <h1>
                {title} 
              </h1> 
            </span>
        ...
        <p className="card_description mt-3 mb-3 font-poppins font-light p-2">
          {description}
        </p>
        </div>
    )
